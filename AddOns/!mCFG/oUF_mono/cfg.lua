  ...
  cfg.oUF = { 
	...
	settings = {		-- general settings
		...
		show_class = true,					-- display additional class indication @ unit frames
	...
	frames = {			-- unit frames settings
		...
		raid = {						-- Raid frames configuration
			...
			main_tank = { 
				...
				["position"] = {"BOTTOMLEFT", "UIParent", "BOTTOMRIGHT", -563, 243},	-- MTs frame position
