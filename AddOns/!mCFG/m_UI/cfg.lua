...
cfg.script = { 
	screenshot_quality = 12,
}

cfg.modules = {
	cooldown_count = true, 			-- enable cooldown count
	show_durability	= true,				-- display durability @ charracter tab
	hide_errors = false,  			-- hide blizzard's default error frame; type /error to see last error
	...
	chat = {		-- chat module settings
		...
		["fontsize"] = 11,						-- main chat window font size
		["spam_filter"] = false,					-- enable chat throttling for repeated messages
...
cfg.automation = {		-- automation settings 
	...
	repair				= true,							-- automatic repair at vendors
